<?php
/**
 * bhmhs001 functions and definitions
 *
...
if ( ! function_exists( 'bhm_setup' ) ) :
	...
	function bhm_setup() {
		 ...
		 * If you're building a theme based on bhmhs001, use a find and replace
		 * to change 'bhm' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bhm', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'bhm_setup' );
 ...
 */
function bhm_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'bhm_content_width', 640 );
}
add_action( 'after_setup_theme', 'bhm_content_width', 0 );
 ...
 */
function bhm_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bhm' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bhm' ),
...
add_action( 'widgets_init', 'bhm_widgets_init' );
...
function bhm_scripts() {
	...
	wp_enqueue_script( 'bhm-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
